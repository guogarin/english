...
### 0.1.2 反义词
mental√ or spiritual?
> mental work / labor 脑力劳动
> 

`spiritual`的反义词是`material `

### 0.1.3 词根`man(u)`
`man(u)` = hand
`manufacture` n. 批量生产；工业品；大量制造
> (NCE3-26 P126-L12) biscuit manufacturers
> 
> (NCE3-45 P208-L20) soap manufacturers
> 
`manacle` /ˈmænəkl/ 
> n. 手铐；镣铐；脚镣
> vt. 给…戴上镣铐
...
> 废奴宣言
> 
emancipate一般指解放人，解放国家用liberate
...
**(5) PHRASE `gets hot under the collar about sb` 生气;愤怒;激动**
...
&emsp;
## 0.3 sacrifice ['sækrɪfaɪs] 
### 0.3.1 释义
**(1) VERB [动词+名词短语] `~ sth (for sb/sth)`牺牲；献出**
...
> 
**(2) VERB [动词+名词短语, 单独使用的动词] 以（人或动物）作祭献**
> The priest sacrificed a chicken...
> 祭司用一只鸡作祭品。
> 

**(3) NOUN [可数名词, 不可数名词] 牺牲；舍弃**
...
> 牺牲生命
> 
**(4) NOUN `~ (to sb)` [可数名词, 不可数名词] 祭献；祭祀；祭献的牲畜；祭品**
...
> 
`cede` 在殖民史语境中多译为"割让"（如香港被割让给英国），商业场景则常用"转让"。这个词隐含权力不对等的意味，通常涉及重要权益的被动放弃。
...
**(2) noun [不可数名词] (disapproving)（有钱有势者的）特权，特殊待遇**
...
**(4) noun [可数名词, 不可数名词] (technical 术语)免责特权**
...
**(5) verb [动词+名词短语] (formal)给予特权；特别优待**
...
&emsp; 
## 0.5 corporation /ˌkɔːrpəˈreɪʃn/
n. 公司
`corporation`比较正式，一般用在公司名称上
...
## 1.1 句子分析
<u>These days</u>, people <span style="color:blue; ">who do manual work</span> often receive far more money <u>than people</u> <span style="color:blue; ">who work in offices</span>.

##  1.2 `these days` 
### 1.2.1 释义
**① 近来/最近（强调时间上的临近性）**
> These days, more people work remotely. 
> 近来，越来越多人远程工作。
> 
**② 如今/现如今（带有与过去对比的意味）**
> These days, technology develops so fast. 
> 如今科技发展得真快。
> 
**③ 这几天（特指短期的近期）**
...
### 1.2.3 反义词
`in those days` 在当时，在那个年代（强调历史时期）
...
far在这里是加强比较级
### 同义替换
much / even / still / yet more

### 程度轻一点的加强
slightly / a little / a bit more

## 1.5 造句：现如今，在娱乐界 (the entertainment field) 工作的人挣的钱往往比在教育行业(the education sector) 工作的人多得多。
...
## 4.4 造句: 压力 (stress) 会导致精神上的一些疾病 (mental diseases), 正如在通用汽车公司(General Motors) 工作的工程师 Mike Johnson 身上发生的情况一样。
