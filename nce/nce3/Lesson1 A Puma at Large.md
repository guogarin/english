...
**(2) spot既然可以表示斑点，那自然可以演示出另一个意思：“污点”**
`a spot on one’s reputation` 某人的污点

**(3) 地点**
`a scenic/tourist spot`景点
> A great many of scenic spots are being spoilt by the ill-behaved tourists.
> The Middle East is a hot spot. 中东是一个（发生战斗或政治动乱的）热点地区。
> 
...
**(2) self-evident** (自己可以证明自己的)，即：
> adj. 不言而喻的；显而易见的；明摆着的
>
例句：
...
> 尼克松总统迫于压力（水门事件）辞职。
> 
 (2) `be/feel impelled to do`，`impel`更偏向于 由于内在压力而感到必须做某事，例句：
...
> 
固定搭配：`somewhere around/between` 大约…；…左右
